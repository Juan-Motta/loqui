...
//
// Vendored from OpenWhispr (https://github.com/OpenWhispr/openwhispr),
// file resources/macos-globe-listener.swift, MIT License.
// Copyright (c) 2024 OpenWhispr Team. See resources/native/NOTICE.
//
// Reused unmodified for loqui (spike S2): a standalone macOS helper that
// reports Globe/fn key hold/release over stdout using a global flagsChanged
// monitor. Requires Accessibility / Input Monitoring permission to receive
// events. Output protocol (one line each, stdout, flushed):
//   FN_DOWN | FN_UP | FN_INTERRUPTED | RIGHT_MOD_DOWN:<name> |
//   RIGHT_MOD_UP:<name> | MODIFIER_UP:<name> | MOUSE_BUTTON_DOWN/UP:<name>
