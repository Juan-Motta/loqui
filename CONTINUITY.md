...
- **Focus:** reconnect lifecycle fix complete and integrated locally into `main`. Failed
...
- **Active workflow:** `.workflow/state.md` (`fix-bug`, phase `complete`). Design:
  ...
  `./scripts/task.sh check`, and all workflow gates exited 0 on 2026-08-07. The fix was merged
  locally and its feature branch deleted; no push or PR was created.
